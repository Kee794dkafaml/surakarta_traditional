...
inline constexpr BitboardTables kStaticBitboardTables = [] {
    ...
    tables.capture_clear_mask = std::array<std::array<std::array<Bitboard, 8>, 36>, 36>{
        std::array<std::array<Bitboard, 8>, 36>{
            std::array<Bitboard, 8>{
                0x0ull,
                0x0ull,
                0x0ull,
                0x0ull,
    ...
    tables.capture_start_dir = std::array<std::array<std::array<std::uint8_t, 8>, 36>, 36>{
        std::array<std::array<std::uint8_t, 8>, 36>{
